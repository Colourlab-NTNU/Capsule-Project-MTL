...
networks['def_file'] = 'architectures/MultiHeadAlexNet.py'
networks['opt'] = net_opt 
networks['optim_params'] = net_optim_params
config['networks'] = networks

criterions = {}
criterions['loss'] = {'ctype':'CrossEntropyLoss', 'opt':None, 'weighted':None}
config['criterions'] = criterions
config['algorithm_type'] = 'ClassificationModel'
config['tbX_run'] = 'run_01_'
