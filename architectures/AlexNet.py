...
class MultiHeadAlexNet(nn.Module):
    def __init__(self, opt):
        super(MultiHeadAlexNet, self).__init__()
    ...
    def _parse_out_keys_arg(self, out_feat_keys):
        ...
        out_feat_keys = [self.all_feat_names[-1] if out_feat_keys is None else out_feat_keys][0]
